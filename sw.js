const CACHE_NAME = 'harilanto-portfolio-production-v1';
const ASSETS = ['/', '/index.html', '/cv.html', '/assets/css/style.css', '/assets/js/main.js', '/assets/img/profile.webp', '/assets/img/og-image.png', '/favicon.svg'];
